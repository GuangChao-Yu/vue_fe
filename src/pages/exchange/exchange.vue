<template>
  <div class="exchange-details">
    <!-- tab切换 -->
    <div class="tabs-list flex-box text-center tabs-list-lol">
      <div class="flex-item tabs-item" v-for="(item,index) in tabs" :key="index" @click="toggleTab(item,index)" :class="activeTab == item ? 'active-bar':'' ">{{ item }}
        <div class="free"></div>
      </div>
    </div>
    ...
    <div class="page-list">
      <ul class="page-list-body" v-show="index===0">
        <li class="page-list-body-li" v-for='(item,index) in getProductList' :key="item" @click="goDetails(item,index)">
    ...
    <div class="tengXun-list">
      <ul class="tengXun-list-body" v-show="index===1">
        <li class="page-list-body-li" v-for='(item,index) in getExchange' @click="goQbDetails(item,index)" :key="index">
          <div class="page-list-body-img">
            <img :src="item.picture" />
          </div>
          <div class="hero-nam">
