<template>
  <div class="game-map-warp">
    <!-- 上单位置 -->
        <!-- 未选中状态 -->
        <div class="line-up-position clearfix top-position" v-if="!isSelectTop">
          ...
          <div class="position-body ">
            <div class="left text-right">
              ...
              <span class="text-right">选择上单</span>
            </div>
          </div>
          <div class="position-footer"></div>
        </div>
        <!-- 选中状态 -->
        <div class="line-up-position clearfix top-position data-bg" v-else>
          <div class="position-header clearfix clear-margin">
            ...
            <div class="right">
              <div class="player-data clearfix">
                KDA: <span>{{ getTop.players_kda }}</span>
              </div>
              <div class="player-data clearfix">
                STP: <span>{{ getTop.players_fppg }}</span>
              </div>
              <div class="player-data clearfix">
                参团率: <span>{{ getTop.players_kp }}</span>
              </div>
            </div>
          </div>
          <div class="position-body clearfix">
            <div class="left text-right">
              <span><img :src="getTop.teams_img_url" alt=""></span>
          ...
          <div class="position-footer">
            ...
            <div class="clearfix right">
              薪水:<span class="right">{{ getTop.players_salary }}</span>
            </div>
          </div>
        </div>
    <!-- 中单位置 -->
        <!-- 未选中状态 -->
        <div class="line-up-position clearfix mid-position" v-if="!isSelectMid">
          <div class="position-header clearfix">
            <div class="left">
              <img src="../../assets/lineUp/men_unchosen@2x.png" alt="">
            </div>
        ...
        <!-- 选中状态 -->
        <div class="line-up-position clearfix mid-position data-bg" v-else>
          <div class="position-header clearfix clear-margin">
            <div class="left">
            ...
            <div class="right">
              <div class="player-data clearfix">
                KDA: <span>{{ getMid.players_kda }}</span>
              </div>
              <div class="player-data clearfix">
                STP: <span>{{ getMid.players_fppg }}</span>
              </div>
              <div class="player-data clearfix">
                参团率: <span>{{ getMid.players_kp }}</span>
              </div>
            </div>
          </div>
          <div class="position-body clearfix">
            <div class="left text-right">
              <span><img :src="getMid.teams_img_url" alt=""></span>
          ...
          <div class="position-footer">
            ...
            <div class="clearfix right">
              薪水:<span class="right">{{ getMid.players_salary }}</span>
            </div>
          </div>
        </div>
    <!-- 打野位置 -->
        <!-- 未选中状态 -->
        <div class="line-up-position clearfix jun-position" v-if="!isSelectJug">
          <div class="position-header clearfix">
            <div class="left">
              <img src="../../assets/lineUp/men_unchosen@2x.png" alt="">
            </div>
        ...
        <!-- 2.选中队员 -->
        <div class="line-up-position clearfix jun-position data-bg" v-else>
          <div class="position-header clearfix clear-margin">
            <div class="left">
            ...
            <div class="right">
              <div class="player-data clearfix">
                KDA: <span>{{ getJug.players_kda }}</span>
              </div>
              <div class="player-data clearfix">
                STP: <span>{{ getJug.players_fppg }}</span>
              </div>
              <div class="player-data clearfix">
                参团率: <span>{{ getJug.players_kp }}</span>
              </div>
            </div>
          </div>
          <div class="position-body clearfix">
            <div class="left text-right">
              <span><img :src="getJug.teams_img_url" alt=""></span>
          ...
          <div class="position-footer">
            ...
            <div class="clearfix right">
              薪水:<span class="right">{{ getJug.players_salary }}</span>
            </div>
          </div>
        </div>
    <!-- ADC位置 -->
        <!-- 未选中状态 -->
        <div class="line-up-position clearfix adc-position" v-if="!isSelectADC">
          <div class="position-header clearfix">
            <div class="left">
              <img src="../../assets/lineUp/men_unchosen@2x.png" alt="">
            </div>
          ...
          <div class="position-body ">
            <div class="left text-right">
              ...
              <span class="text-right">选择ADC</span>
            </div>
          </div>
          <div class="position-footer"></div>
        </div>
        <!-- 2.选中队员 -->
        <div class="line-up-position clearfix adc-position data-bg" v-else>
          <div class="position-header clearfix clear-margin">
            <div class="left">
            ...
            <div class="right">
              <div class="player-data clearfix">
                KDA: <span>{{ getAdc.players_kda }}</span>
              </div>
              <div class="player-data clearfix">
                STP: <span>{{ getAdc.players_fppg }}</span>
              </div>
              <div class="player-data clearfix">
                参团率: <span>{{ getAdc.players_kp }}</span>
              </div>
            </div>
          </div>
          <div class="position-body clearfix">
            <div class="left text-right">
              <span><img :src="getAdc.teams_img_url" alt=""></span>
          ...
          <div class="position-footer">
            ...
            <div class="clearfix right">
              薪水:<span class="right">{{ getAdc.players_salary }}</span>
            </div>
          </div>
        </div>
     <!-- 辅助位置 -->
        <!-- 未选中状态 -->
        <div class="line-up-position clearfix sup-position" v-if="!isSelectSup">
          <div class="position-header clearfix">
            <div class="left">
              <img src="../../assets/lineUp/men_unchosen@2x.png" alt="">
            </div>
          ...
          <div class="position-body ">
            <div class="left text-right">
              ...
              <span class="text-right">选择辅助</span>
            </div>
          </div>
          <div class="position-footer"></div>
        </div>
        <!-- 2.选中队员 -->
        <div class="line-up-position clearfix sup-position data-bg" v-else>
          <div class="position-header clearfix clear-margin">
            <div class="left">
            ...
            <div class="right">
              <div class="player-data clearfix">
                KDA: <span>{{ getSup.players_kda }}</span>
              </div>
              <div class="player-data clearfix">
                STP: <span>{{ getSup.players_fppg }}</span>
              </div>
              <div class="player-data clearfix">
                参团率: <span>{{ getSup.players_kp }}</span>
              </div>
            </div>
          </div>
          <div class="position-body clearfix">
            <div class="left text-right">
              <span><img :src="getSup.teams_img_url" alt=""></span>
          ...
          <div class="position-footer">
            ...
            <div class="clearfix right">
              薪水:<span class="right">{{ getSup.players_salary }}</span>
            </div>
          </div>
        </div>
    <!-- 替补位置 -->
        <!-- 未选中状态 -->
        <div class="line-up-position clearfix flex-position" v-if="!isSelectBench">
          <div class="position-header clearfix">
            <div class="left">
              <img src="../../assets/lineUp/men_unchosen@2x.png" alt="">
            </div>
        ...
        <!-- 2.选中队员 -->
        <div class="line-up-position clearfix flex-position data-bg" v-else>
          <div class="position-header clearfix clear-margin">
            <div class="left">
            ...
            <div class="right">
              <div class="player-data clearfix">
                KDA: <span>{{ getBench.players_kda }}</span>
              </div>
              <div class="player-data clearfix">
                STP: <span>{{ getBench.players_fppg }}</span>
              </div>
              <div class="player-data clearfix">
                参团率: <span>{{ getBench.players_kp }}</span>
              </div>
            </div>
          </div>
          <div class="position-body clearfix">
            <div class="left text-right">
              <span><img :src="getBench.teams_img_url" alt=""></span>
          ...
          <div class="position-footer clearfix">
            ...
            <div class="clearfix right">
              薪水:<span class="right">{{ getBench.players_salary }}</span>
            </div>
          </div>
        </div>
  </div>
